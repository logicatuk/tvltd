...
<html lang="en">
   <head>
     ...
     <script src="//code.tidio.co/9v7xqx9fgnxs6mqqra8d42wuthdisolh.js" async=""></script>
      ...
      <div id="login" class="container-fluid standard-bg">
         ...
         <div class="row header-top">
            <div class="col-lg-3 col-md-6 col-sm-12">
               <a class="main-logo" href="index.php"><img style="height:39px;" src="https://web.iptvltd.com/img/banner_w.png" class="main-logo" alt="<?php echo NOME_IPTV; ?>" title="<?php echo NOME_IPTV; ?>"></a>
            </div>
