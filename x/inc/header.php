<div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
               <a class="main-logo" href="painel.php?sessao=<?php echo gerar_hash(256); ?>"><img style="height:36px;" src="https://web.iptvltd.com/img/banner_w.png" class="main-logo img-responsive" alt="<?php echo NOME_IPTV; ?>" title="<?php echo NOME_IPTV; ?>"></a>
            </div>
