...
if ($activePage !== "index" && $activePage !== "dashboard") {
    ...
    echo "\"><a href=\"https://www.iptvltd.com/pricing\"><span class=\"da radio\"></span><span>Radio</span></a></li> -->\r\n          \r\n        </ul>\r\n        <ul class=\"nav navbar-nav navbar-right r-icon\">\r\n         ";
    if ($activePage !== "dashboard" && $activePage !== "settings") {
    ...
    if ($activePage !== "dashboard" && $activePage !== "settings") {
        echo " \r\n\r\n          <li class=\"r-li\"><a href=\"https://www.iptvltd.com/resellers?utm_source=web-player&utm_id=iptvweb\" class=\"\"><i class=\"fa fa-sign-out\"></i><span class=\"r-show\">Resellers</span></a></li>\r\n        ";
       echo " \r\n\r\n          <li class=\"r-li active\"><a href=\"https://www.iptvltd.com/pricing?utm_source=web-player&utm_id=iptvweb\" style=\"background-color: #5C2D94 !important; font-weight: 400; float: left; color: white; text-decoration: none; \"><span class=\"r-show\">Subscription</span></a></li>\r\n";
